      ...
      <section className="relative h-[85vh] flex items-center justify-center overflow-hidden">
        ...
        <div className="container relative z-10 px-6 sm:px-12">
          <div className="max-w-2xl animate-fade-in">
            <span className="text-[var(--accent-primary)] text-sm font-bold tracking-[0.3em] uppercase mb-4 block">
              Luxe Jewels Exclusive
            </span>
            <h1 className="text-5xl sm:text-7xl font-bold mb-6 text-white leading-tight drop-shadow-2xl" style={{ fontFamily: 'var(--font-heading)' }}>
              A Legacy of <br />
              <span className="text-transparent bg-clip-text bg-gradient-to-r from-[var(--accent-primary)] to-[#fffacd]">
                Brilliance
              </span>
            </h1>
            <p className="text-lg text-gray-300 mb-10 leading-relaxed max-w-xl animate-fade-in-delayed drop-shadow-md">
            ...
            <div className="flex gap-4 animate-fade-in-delayed" style={{ animationDelay: '0.6s' }}>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(300px, 1fr))', gap: '2rem' }}>
            <Link to="/products?category=Rings" className="category-link block group" style={{ height: '400px' }}>
              <div 
                ...
                style={{ backgroundImage: 'url(/category_rings_1778247537619.png)' }}
              ></div>
            ...
            <Link to="/products?category=Necklaces" className="category-link block group" style={{ height: '400px' }}>
              <div 
                className="bg-div absolute inset-0 bg-cover bg-center" 
                style={{ backgroundImage: 'url(/category_necklaces_1778247616382.png)' }}
              ></div>
              <div className="absolute inset-0 overlay"></div>
              <div className="absolute bottom-10 left-10 z-10">
                <h3 className="text-4xl font-bold text-white mb-3" style={{ fontFamily: 'var(--font-heading)' }}>Necklaces</h3>
                <span className="text-[var(--accent-primary)] text-sm font-bold tracking-widest uppercase flex items-center gap-2">
                   Explore <span className="transition-transform group-hover:translate-x-3">→</span>
                </span>
              </div>
            ...
            <Link to="/products?category=Earrings" className="category-link block group" style={{ height: '400px' }}>
               <div 
                className="bg-div absolute inset-0 bg-cover bg-center" 
                style={{ backgroundImage: 'url(/category_earrings_1778247638003.png)' }}
              ></div>
              <div className="absolute inset-0 overlay"></div>
              <div className="absolute bottom-10 left-10 z-10">
            ...
            <Link to="/products?category=Bracelets" className="category-link block group" style={{ height: '400px' }}>
              <div 
                className="bg-div absolute inset-0 bg-cover bg-center" 
                style={{ backgroundImage: 'url(/category_bracelets_new_1778247678940.png)' }}
              ></div>
              <div className="absolute inset-0 overlay"></div>
              <div className="absolute bottom-10 left-10 z-10">
                <h3 className="text-4xl font-bold text-white mb-3" style={{ fontFamily: 'var(--font-heading)' }}>Bracelets & Bangles</h3>
                <span className="text-[var(--accent-primary)] text-sm font-bold tracking-widest uppercase flex items-center gap-2">
                   Explore <span className="transition-transform group-hover:translate-x-3">→</span>
                </span>
              </div>
